    ...
    return (
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="relative aspect-video">
                <Image src={imageUrl} alt={`${title} screenshot`} fill className="object-cover" />
            </div>
                    ...
                    <div className="flex space-x-3">
                        ...
                        >
                            ...
                            <div className="relative w-4 h-4">
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_URL}/images/games_build_icon_windows.png`}
                                    alt="Windows icon"
                                    width={16}
                                    height={16}
                                />
                        ...
                        >
                            ...
                            <div className="relative w-4 h-4">
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_URL}/images/games_build_icon_mac.png`}
                                    alt="Mac icon"
                                    width={16}
                                    height={16}
                                />
