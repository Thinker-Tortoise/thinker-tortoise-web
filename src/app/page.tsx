    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <section className="my-12" id="games">
          <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">OUR PROJECTS</h2>
      ...
      <section className="py-8 bg-white">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-center items-center gap-6">
          ...
          >
            <span className="font-bold text-gray-800 flex-grow text-center pr-4">FOLLOW FOR UPDATES</span>
          ...
          <Link 
            ...
            className="flex items-center justify-between bg-gray-200 hover:bg-gray-300 transition px-6 py-4 rounded-full w-full md:w-[32%]"
          >
            <span className="font-bold text-gray-800 flex-grow text-center pr-4">JOIN THE CONVERSATION</span>
            <div className="relative w-10 h-10 flex-shrink-0">
              <Image 
